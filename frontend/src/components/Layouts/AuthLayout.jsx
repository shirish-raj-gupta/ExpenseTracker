...
<div className="hidden md:block w-1/2 h-screen bg-violet-50 bg-auth-bg-img bg-cover bg-no-repeat bg-center overflow-hidden p-8 relative ml-auto">
      ...
      <div className="w-48 h-48 rounded-[40px] bg-violet-500 absolute -bottom-7 -left-7"></div>
